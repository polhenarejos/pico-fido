...
file_t file_entries[] = {
    ...
    { .fid = EF_PIN_COMPLEXITY_POLICY,  .parent = 0, .name = NULL, .type = FILE_TYPE_INTERNAL_EF | FILE_DATA_FLASH, .data = NULL, .ef_structure = FILE_EF_TRANSPARENT, .acl = { 0xff } }, // PIN COMPLEXITY POLICY
